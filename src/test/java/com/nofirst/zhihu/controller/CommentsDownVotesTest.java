...
class CommentsDownVotesTest extends BaseContainerTest {
    ...
    void authenticated_user_can_vote_down() throws Exception {
        ...
        Vote vote = voteDao.selectByVotedId(1, Comment.class.getSimpleName(), VoteActionType.VOTE_DOWN.getCode());
    ...
    void an_authenticated_user_can_cancel_vote_down() throws Exception {
        ...
        // then
        vote = voteDao.selectByVotedId(1, Comment.class.getSimpleName(), VoteActionType.VOTE_DOWN.getCode());
